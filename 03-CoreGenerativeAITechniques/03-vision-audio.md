...
> 🧑‍💻**Sample code**: You can follow [along with sample code here](../../samples/CoreGenerativeAITechniques/Vision-01MEAI-GitHubModels/).
>
> We also have examples showing vision capabilities with:
> - [Ollama](../../samples/CoreGenerativeAITechniques/Vision-02MEAI-Ollama/) - Using local Ollama models for vision tasks
> - [Azure OpenAI](../../samples/CoreGenerativeAITechniques/Vision-03MEAI-AOAI/) - Using Azure OpenAI for vision tasks
> - [Azure OpenAI with Spectre UI](../../samples/CoreGenerativeAITechniques/Vision-04MEAI-AOAI-Spectre/) - A more advanced UI using the Spectre console library
...
> 🧑‍💻**Sample code**: You can follow [along with sample code here](../../samples/CoreGenerativeAITechniques/Audio-01-SpeechMic/).
...
We have another example that [demonstrates how to perform real-time audio conversation with Azure Open AI](../../samples/CoreGenerativeAITechniques/Audio-02-RealTimeAudio/) - check it out!
