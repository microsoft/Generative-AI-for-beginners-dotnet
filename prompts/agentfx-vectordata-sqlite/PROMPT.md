...
Once the library is on NuGet, update the 5 AgentFx projects:
...
7. Update `docs/changelog/2025-sk-deprecation-nuget-upgrades.md` to mark the AgentFx item as DONE
