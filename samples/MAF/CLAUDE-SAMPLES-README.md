# MAF Claude Samples - Microsoft Foundry Integration
...
### 1. MAF-FoundryClaude-01 - Basic Chat
...
[Full Documentation →](./MAF-FoundryClaude-01/README.md)

---

### 2. MAF-FoundryClaude-Persisting-01 - Conversation Persistence
...
[Full Documentation →](./MAF-FoundryClaude-Persisting-01/README.md)

---

### 3. MAF-AIWebChatApp-FoundryClaude - Blazor Web Chat
...
[Full Documentation →](./MAF-AIWebChatApp-FoundryClaude/README.md)
...
```bash
dotnet add package Microsoft.Agents.AI.Core --version 1.0.0
