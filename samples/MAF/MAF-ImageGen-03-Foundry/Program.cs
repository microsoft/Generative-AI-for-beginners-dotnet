...
// (MAF + A2A + NVIDIA NeMo). A Microsoft Agent Framework (MAF) AIAgent is given an image
...
//
// Usage:
//      dotnet run                       # uses the built-in incident-hero prompt
...
// The request: a CLI argument, or the default incident-hero prompt (the Zava cold-open image).
