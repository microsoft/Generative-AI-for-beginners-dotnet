...
![Azure OpenAI 頁面示意圖，展示多個生成式 AI 模型](../../../translated_images/github-models-webapge.25ecc6d29afdb2dedd949b0e5279cff6dd799af74c427d1036002f18249b9889.tw.png)
...
**選項 2: C# (.NET) - Ollama**：Ollama 允許你運行演示而無需連接到 Azure OpenAI 或 Azure OpenAI。它包含所有核心 .NET 開發工具以及 Ollama，但啟動速度較慢，平均需時五分鐘。[按照此指南](getting-started-ollama.md)來使用 Ollama。
...
- [Azure OpenAI 文件](https://docs.github.com/en/github-models/prototyping-with-ai-models)
