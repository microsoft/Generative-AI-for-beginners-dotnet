...
Esta lección te guiará para configurar tu entorno de desarrollo para este curso. Para garantizar tu éxito, hemos preparado una configuración de devcontainer que incluye todas las herramientas que necesitarás para completar el curso. Puedes ejecutar el devcontainer en GitHub Codespaces (recomendado) o localmente en tu máquina. También te mostraremos cómo configurar tus tokens de acceso de GitHub para interactuar con Azure OpenAI.
...
- 🤖 Configurar tu entorno para acceder a LLMs mediante Azure OpenAI, Azure OpenAI u Ollama
...
Proveemos instrucciones para configurar tu entorno de desarrollo con Azure OpenAI, Azure OpenAI y Ollama. Puedes elegir el que mejor se adapte a tus necesidades. Recomendamos usar Azure OpenAI para este curso, aunque cualquiera de los tres servicios es válido.

Aquí tienes un resumen rápido de los servicios:

- **Azure OpenAI**: Un servicio gratuito para comenzar, que te permite probar e interactuar con varios modelos de IA directamente en tu entorno de desarrollo. Es fácil de usar desde Codespaces y es ideal para experimentar con diferentes modelos y comprender sus capacidades antes de implementarlos.
...
> Si **Azure OpenAI** es tu elección, sigue el resto de este documento para configurar tu entorno de desarrollo con Azure OpenAI.
...
1. Genera un Nuevo Token:
    ...
    - **Importante**: Debes seleccionar el permiso **`models:read`** para que este token funcione con Azure OpenAI.
...
**Opción 1: C# (.NET)**: Esta es la opción que deberías usar si planeas usar Azure OpenAI y es nuestra recomendación para completar este curso. Incluye todas las herramientas esenciales de desarrollo en .NET necesarias para el curso y tiene un tiempo de inicio rápido.

**Opción 2: C# (.NET) - Ollama**: Ollama te permite ejecutar los demos sin necesidad de conectarte a Azure OpenAI o Azure OpenAI. Incluye todas las herramientas esenciales de desarrollo en .NET además de Ollama, pero tiene un tiempo de inicio más lento, en promedio cinco minutos. [Sigue esta guía](getting-started-ollama.md) si deseas usar Ollama.
...
## Verificando que tu Codespace funciona correctamente con Azure OpenAI
...
En esta lección, aprendiste cómo configurar tu entorno de desarrollo para el resto del curso. Creaste un GitHub Codespace y lo configuraste para usar Azure OpenAI, Azure OpenAI u Ollama. También aprendiste a crear un token de acceso personal para Azure OpenAI y cómo ejecutar una aplicación de ejemplo para verificar que todo funciona correctamente.
...
- [Documentación de Azure OpenAI](https://docs.github.com/en/github-models/prototyping-with-ai-models)
