...
在 [DockerModels-02-MEAI-Chat](./src/DockerModels-02-MEAI-Chat) 和 [DockerModels-02-MEAI-Chat](./src/DockerModels-02-MEAI-Chat) 示例中，我们实现了使用 Microsoft.Extensions.AI 来利用本地模型的应用程序。
