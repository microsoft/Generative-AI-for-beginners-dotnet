...
- 🔍 MEAI, Azure OpenAI 등 .NET AI 개발 도구 탐구하기

## .NET을 위한 생성형 AI 기초

코드를 다루기 전에, 잠시 시간을 내어 생성형 AI(GenAI)의 개념을 복습해봅시다. 이번 강의인 **.NET을 위한 생성형 AI 기초**에서는 중요한 GenAI 개념을 복습하여 특정 작업들이 왜 그렇게 수행되는지 이해할 수 있도록 돕습니다. 또한, **MEAI**(Microsoft.Extensions.AI), **VS Code용 AI Toolkit Extension**과 같은 앱 개발에 사용할 도구와 SDK를 소개합니다.
