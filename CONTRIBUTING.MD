...
- **Volunteers are responsible for reviewing and updating translations** for any major changes to the guide in their respective language(s).
- Volunteers must keep their contributed content and translations up to date with the main repository.
- When major updates are announced, volunteers will be pinged and are expected to take prompt action to review and update their translations.

### Issue-First Approach

**⚠️ Important: No change or update can be made without first opening an issue.**
...
- Changes are coordinated and aligned with project goals
- Duplicate work is avoided
- The community can provide input before work begins
- Major changes can be properly planned and communicated
...
2. **Volunteers are expected to respond within a reasonable timeframe** to acknowledge the notification
3. **Volunteers should provide an estimated timeline** for completing the required updates
4. If a volunteer is unable to complete the work, they should communicate this promptly so others can assist
